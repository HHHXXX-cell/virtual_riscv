...
24. **【开工即自动推进】会话第一件事就是继续循环，不等指令**（R0 2026-09-24 定；SSOT＝`doc/自动推进说明.md`）：
    ...
    ⑤**默认不请示**（`doc/项目开发流程.md` §12.2）——"要不要继续"不是问题，除非撞 ③/④；运行痕迹按 ②归档，不得口头声明。
